...
create_enemy_with_shoot(room10, path_enemy11, velocity=5, up_down_around=0, health=100, frequency=6)
create_enemy_with_shoot(room10, path_enemy11, velocity=7, up_down_around=3, health=100, frequency=6)
create_enemy_with_shoot(room10, path_enemy11, velocity=15, up_down_around=2, health=100, frequency=6)
create_enemy_with_shoot(room10, path_enemy11, velocity=2, up_down_around=2, health=100, frequency=6)
create_enemy_with_shoot(room10, path_enemy11, velocity=3, up_down_around=3, health=100, frequency=6)
create_enemy_with_shoot(room10, path_enemy11, velocity=8, up_down_around=1, health=100, frequency=6)
create_enemy_with_shoot(room10, path_enemy11, velocity=9, up_down_around=3, health=100, frequency=9)
...
create_enemy_with_shoot(room10, path_enemy11, velocity=11, up_down_around=3, health=100, frequency=9)
...
create_enemy_with_shoot(room10, path_enemy11, velocity=10, up_down_around=3, health=100, frequency=13)
create_enemy_with_shoot(room10, path_enemy11, velocity=4, up_down_around=0, health=100, frequency=13)
create_enemy_with_shoot(room10, path_enemy11, velocity=5, up_down_around=3, health=100, frequency=13)
create_enemy_with_shoot(room10, path_enemy11, velocity=6, up_down_around=0, health=100, frequency=13)
create_enemy_with_shoot(room10, path_enemy11, velocity=7, up_down_around=3, health=100, frequency=13)
