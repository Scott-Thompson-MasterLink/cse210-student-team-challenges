...
enemy3 = Enemy(path_enemy3, SPRITE_SCALING,max_health=2)
enemy4 = Enemy(path_enemy3, SPRITE_SCALING,max_health=2)
enemy3.position_enemy(400, 150)
enemy4.position_enemy(600, 500)
